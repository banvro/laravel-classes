                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="contact_form_inner">
                                    <form action="/update-this/{{$data->id}}" method="POST">
                                        @csrf
                                        <div class="contact_field">
                                            <h3>Contatc Us</h3>
                                            <p>Feel Free to contact us any time. We will get back to you as soon as we can!.</p>
                                            <input type="text" name="fname" value="{{$data->full_Name}}" class="form-control form-group" placeholder="Name" />
                                            <input type="text" name="email" value="{{$data->email}}" class="form-control form-group" placeholder="Email" />
                                            <textarea name="msg" class="form-control form-group" placeholder="Message">{{$data->message}}</textarea>
